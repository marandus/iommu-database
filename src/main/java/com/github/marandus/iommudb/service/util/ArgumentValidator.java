 ...
 */
package com.github.marandus.iommudb.service.util;
...
public class ArgumentValidator {
	 ...
	 * {@link StringUtils#isBlank(java.lang.CharSequence) StringUtils.isBlank()} method. If <tt>arg</tt> is blank, an
	...
	/**
	 * Test the length <tt>arg</tt> against the provided length using the specified compare operator. If the result of the
	...
	/**
	 * Test <tt>arg</tt> to be non-null as defined by the {@link Objects#isNull(java.lang.Object) Objects.isNull()} method. If
	 * <tt>arg</tt> is null, an IllegalArgumentException will be raised. The exception message will be constructed as follows:
	 * <p>
	 * <tt>"NULL: " + msg</tt>
	 *
	 * @param arg Argument to test
